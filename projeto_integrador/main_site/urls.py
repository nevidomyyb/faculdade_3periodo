...
from main_site.views.projeto_views import excluir_projeto, visualizar_projeto, editar_projeto,performar_editar_projeto, criar_projeto, performar_criar_projeto
...
urlpatterns = [
    ...
    path('projeto/excluir/<int:pk>/', excluir_projeto, name='excluir_performar')
]